    ...
    if st.button("Generate Forecasts", type="primary"):
        with st.spinner("Processing pipeline..."):
            ...
            try:
                ...
                st.subheader("Generated Forecasts by Gateway")
                ...
                for tab, gw in zip(tabs, gateways):
                    with tab:
                        ...
                        fig = px.line(
                            ...
                            x="datetime",
                            y="forecast",
                            title=f"Predicted Transaction Attempts for {gw}",
                            labels={"datetime": "Timestamp", "forecast": "Predicted Attempts"}
                        )
                        fig.update_traces(line_color=color_map.get(gw, "#1f77b4"))
